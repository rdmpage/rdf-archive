...
// Process RDF into batches of ~1000 sets of data
...
function rdf_to_triples($xml)
{
	...
	return $parser->toNTriples($triples);
}
...
$basedir = '/Volumes/WD Elements 1TB/rdf-archive/indexfungorum/rdf';
$outputdir = dirname(__FILE__) . '/indexfungorum/nt';
...
foreach ($files as $directory)
{
	...
	{	
		...
		// dump
		file_put_contents($outputdir . '/' . $directory . '.nt', $nt);
